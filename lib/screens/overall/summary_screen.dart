      ...
      builder: (context, state) {
        if (state is SummaryLoading) {
          ...
          for (var summary in filteredSummaries) {
            ...
            //     totalServiceChargeByType[servicechargeType] = totalServiceChargeByType[servicechargeType]! + depositTotal;
            //   } else {
            //     totalServiceChargeByType[servicechargeType] = depositTotal;
            //   }
          ...
          return Center(
            ...
            child: DataTable(columnSpacing: 20, headingRowHeight: 40, dataRowHeight: 40, columns: [
              ...
              //       ),
              //     ),
              //     DataCell(Text("\$${totalDeposits.toStringAsFixed(2)}")),
              //   ]),
            ]),
          ));
        } else if (state is SummaryError) {
